...
impl<'a, Ind1, Ind2, K: 'a, V: 'a, VTI: ParallelIterator<Item = V> + 'a> CRelIndexReadAll<'a>
   ...
   Ind2: CRelIndexReadAll<'a, Key = K, ValueIteratorType = VTI>,
{
   ...
   fn c_iter_all(&'a self) -> Self::AllIteratorType { self.ind1.c_iter_all().chain(self.ind2.c_iter_all()) }
}
