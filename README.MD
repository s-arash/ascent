...
### Misc
- `#![measure_rule_times]` causes execution times of individual rules to be measured.
 Example: 
 ```Rust
 ascent! {
    #![measure_rule_times]
...
- The feature `wasm-bindgen` allows Ascent programs to run in WASM environemnts.