...
logical indices: edge_indices_0_1_2; edge_indices_1; edge_indices_none*/
    ...
    pub edge_indices_1: ascent::rel::ToRelIndexType<(i32,), (i32, u32)>,
    pub edge_indices_none: ascent::rel::ToRelIndexType<(), (i32, i32, u32)>,
    /**
logical indices: longest_path_indices_0; longest_path_indices_0_1; longest_path_indices_0_1_2*/
    pub longest_path: ::std::vec::Vec<(i32, i32, u32)>,
    pub __longest_path_ind_common: (),
    pub longest_path_indices_0: ascent::internal::LatticeIndexType<(i32,), usize>,
    pub longest_path_indices_0_1: ascent::internal::RelFullIndexType<(i32, i32), usize>,
    pub longest_path_indices_0_1_2: ascent::internal::LatticeIndexType<
        (i32, i32, u32),
        usize,
    >,
...
impl AscentProgram {
    ...
    pub fn run(&mut self) {
        ...
        ascent::internal::comment("scc 0");
        {
            ...
            let mut __longest_path_ind_common_delta: () = ::std::mem::take(
                &mut _self.__longest_path_ind_common,
            );
            let mut __longest_path_ind_common_total: () = Default::default();
            let mut __longest_path_ind_common_new: () = Default::default();
            ::ascent::internal::RelIndexMerge::init(
                &mut __longest_path_ind_common_new,
                &mut __longest_path_ind_common_delta,
                &mut __longest_path_ind_common_total,
            );
            let mut longest_path_indices_0_delta: ascent::internal::LatticeIndexType<
                (i32,),
                usize,
            > = ::std::mem::take(&mut _self.longest_path_indices_0);
            let mut longest_path_indices_0_total: ascent::internal::LatticeIndexType<
                (i32,),
                usize,
            > = Default::default();
            let mut longest_path_indices_0_new: ascent::internal::LatticeIndexType<
                (i32,),
                usize,
            > = Default::default();
            ::ascent::internal::RelIndexMerge::init(
                &mut longest_path_indices_0_new,
                &mut longest_path_indices_0_delta,
                &mut longest_path_indices_0_total,
            );
            let mut longest_path_indices_0_1_delta: ascent::internal::RelFullIndexType<
                (i32, i32),
                usize,
            > = ::std::mem::take(&mut _self.longest_path_indices_0_1);
            let mut longest_path_indices_0_1_total: ascent::internal::RelFullIndexType<
                (i32, i32),
                usize,
            > = Default::default();
            let mut longest_path_indices_0_1_new: ascent::internal::RelFullIndexType<
                (i32, i32),
                usize,
            > = Default::default();
            ::ascent::internal::RelIndexMerge::init(
                &mut longest_path_indices_0_1_new,
                &mut longest_path_indices_0_1_delta,
                &mut longest_path_indices_0_1_total,
            );
            let mut longest_path_indices_0_1_2_delta: ascent::internal::LatticeIndexType<
                (i32, i32, u32),
                usize,
            > = ::std::mem::take(&mut _self.longest_path_indices_0_1_2);
            let mut longest_path_indices_0_1_2_total: ascent::internal::LatticeIndexType<
                (i32, i32, u32),
                usize,
            > = Default::default();
            let mut longest_path_indices_0_1_2_new: ascent::internal::LatticeIndexType<
                (i32, i32, u32),
                usize,
            > = Default::default();
            ::ascent::internal::RelIndexMerge::init(
                &mut longest_path_indices_0_1_2_new,
                &mut longest_path_indices_0_1_2_delta,
                &mut longest_path_indices_0_1_2_total,
            );
            ...
            #[allow(unused_assignments, unused_variables)]
            {
                ...
                ascent::internal::comment("longest_path <-- edge_indices_none_total");
                {
                        ...
                        .index_get(&())
                    {
                        __matching
                            .for_each(|__val| {
                                ...
                                let y: &i32 = __val.1;
                                let ew: &u32 = __val.2;
                                let __new_row: (i32, i32, u32) = (
                                    ascent::internal::Convert::convert(x),
                                    ascent::internal::Convert::convert(y),
                                    ascent::internal::Convert::convert(ew),
                                );
                                let __lattice_key = (
                                    __new_row.0.clone(),
                                    __new_row.1.clone(),
                                );
                                if let Some(mut __existing_ind) = longest_path_indices_0_1_new
                                    .index_get(&__lattice_key)
                                    .or_else(|| {
                                        longest_path_indices_0_1_delta.index_get(&__lattice_key)
                                    })
                                    .or_else(|| {
                                        longest_path_indices_0_1_total.index_get(&__lattice_key)
                                    })
                                {
                                    let __existing_ind = *__existing_ind.next().unwrap();
                                    let __lat_changed = ::ascent::Lattice::join_mut(
                                        &mut _self.longest_path[__existing_ind].2,
                                        __new_row.2.clone(),
                                    );
                                    if __lat_changed {
                                    ...
                                    let __new_row_ind = _self.longest_path.len();
                                    ::ascent::internal::RelIndexWrite::index_insert(
                                        &mut longest_path_indices_0_new,
                                        (__new_row.0.clone(),),
                                        __new_row_ind,
            ...
            _self.__longest_path_ind_common = __longest_path_ind_common_total;
            _self.longest_path_indices_0 = longest_path_indices_0_total;
            _self.longest_path_indices_0_1 = longest_path_indices_0_1_total;
            _self.longest_path_indices_0_1_2 = longest_path_indices_0_1_2_total;
        ...
        ascent::internal::comment("scc 1");
        {
            ...
            let edge_indices_1_total: ascent::rel::ToRelIndexType<(i32,), (i32, u32)> = std::mem::take(
            ...
            loop {
                ...
                ascent::internal::comment(
                    "longest_path <-- edge_indices_1_total, longest_path_indices_0_delta [SIMPLE JOIN]",
                );
                {
                    if edge_indices_1_total.to_rel_index(&__edge_ind_common_total).len()
                        <= (&longest_path_indices_0_delta).len()
                    {
                        edge_indices_1_total
                            ...
                            .for_each(|(__cl1_joined_columns, __cl1_tuple_indices)| {
                                ...
                                if let Some(__matching) = (&longest_path_indices_0_delta)
                                    .index_get(&(y.clone(),))
                                {
                                    __cl1_tuple_indices
                                        .for_each(|cl1_val| {
                                            ...
                                            let x: &i32 = cl1_val.0;
                                            let ew: &u32 = cl1_val.1;
                                            __matching
                                                .clone()
                                                .for_each(|__val| {
                                                    let __row = &_self.longest_path[*__val].clone();
                                                    let z: &i32 = &__row.1;
                                                    let w: &u32 = &__row.2;
                                                    let __new_row: (i32, i32, u32) = (
                                                        ascent::internal::Convert::convert(x),
                        ...
                        (&longest_path_indices_0_delta)
                            ...
                            .for_each(|(__cl1_joined_columns, __cl1_tuple_indices)| {
                                    ...
                                    .index_get(&(y.clone(),))
                                {
                                    __cl1_tuple_indices
                                        .for_each(|cl1_val| {
                                            let __row = &_self.longest_path[*cl1_val].clone();
                                            let z: &i32 = &__row.1;
                                            let w: &u32 = &__row.2;
                                            __matching
                                                .clone()
    ...
    fn update_indices_priv(&mut self) {
        ...
        for (_i, tuple) in self.longest_path.iter().enumerate() {
            let selection_tuple = (tuple.0.clone(),);
            let rel_ind = &mut self.longest_path_indices_0;
            ascent::internal::RelIndexWrite::index_insert(rel_ind, selection_tuple, _i);
            let selection_tuple = (tuple.0.clone(), tuple.1.clone());
            let rel_ind = &mut self.longest_path_indices_0_1;
            ascent::internal::RelIndexWrite::index_insert(rel_ind, selection_tuple, _i);
            let selection_tuple = (tuple.0.clone(), tuple.1.clone(), tuple.2.clone());
            let rel_ind = &mut self.longest_path_indices_0_1_2;
            ascent::internal::RelIndexWrite::index_insert(rel_ind, selection_tuple, _i);
        }
    ...
    fn type_constraints() {
        ...
        let _type_constraints: ascent::internal::LatTypeConstraints<u32>;
    }
    pub fn summary() -> &'static str {
        "scc 0, is_looping: false:\n  longest_path <-- edge_indices_none_total\n  dynamic relations: longest_path\nscc 1, is_looping: true:\n  longest_path <-- edge_indices_1_total, longest_path_indices_0_delta [SIMPLE JOIN]\n  dynamic relations: longest_path\n"
    }
    pub fn relation_sizes_summary(&self) -> String {
        ...
        (&mut res)
            .write_fmt(
                format_args!("{0} size: {1}\n", "longest_path", self.longest_path.len()),
            )
            .unwrap();
        res
    }
...
impl Default for AscentProgram {
    fn default() -> Self {
        let mut _self = AscentProgram {
            ...
            __longest_path_ind_common: Default::default(),
            longest_path_indices_0: Default::default(),
            longest_path_indices_0_1: Default::default(),
            longest_path_indices_0_1_2: Default::default(),
