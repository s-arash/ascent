...
physical indices:
 edge_indices_0_1; edge_indices_1*/
    pub edge: ::ascent::boxcar::Vec<(TNode, TNode)>,
    pub edge_indices_0_1: ascent::internal::CRelFullIndex<(TNode, TNode), ()>,
    pub edge_indices_1: ascent::internal::CRelIndex<(TNode,), (TNode,)>,
    /**
physical indices:
 path_indices_0; path_indices_0_1*/
    pub path: ::ascent::boxcar::Vec<(TNode, TNode)>,
    pub path_indices_0: ascent::internal::CRelIndex<(TNode,), (TNode,)>,
    pub path_indices_0_1: ascent::internal::CRelFullIndex<(TNode, TNode), ()>,
    ...
    TNode: Clone + std::cmp::Eq + std::hash::Hash + Sync + Send,
{
    ...
    pub fn run(&mut self) {
        ...
        ascent::internal::comment("scc 0");
        {
            ...
            let path_indices_0_delta: &mut ascent::internal::CRelIndex<
                (TNode,),
                (TNode,),
            > = &mut _self.path_indices_0;
            let mut path_indices_0_total: ascent::internal::CRelIndex<
                (TNode,),
                (TNode,),
            > = Default::default();
            let mut path_indices_0_new: ascent::internal::CRelIndex<
                (TNode,),
                (TNode,),
            > = Default::default();
            ...
            let mut path_indices_0_1_new: ascent::internal::CRelFullIndex<
                ...
                (),
            > = Default::default();
            let edge_indices_1_total: &mut ascent::internal::CRelIndex<
                (TNode,),
                (TNode,),
    ...
    fn type_constraints() {
        ...
        let _par_constraints: ascent::internal::ParTypeConstraints<TNode>;
    }
