...
physical indices:
 path_indices_0; path_indices_0_1; path_indices_1*/
    ...
    pub path_indices_1: ascent::internal::RelIndexType1<(i32,), (i32,)>,
...
impl TC {
    ...
    pub fn run(&mut self) {
        ...
        ascent::internal::comment("scc 0");
        {
            ...
            let mut path_indices_0_1_new: ascent::internal::RelFullIndexType<
                ...
                (),
            > = Default::default();
            let path_indices_1_delta: &mut ascent::internal::RelIndexType1<
                (i32,),
                (i32,),
            > = &mut _self.path_indices_1;
            let mut path_indices_1_total: ascent::internal::RelIndexType1<
                (i32,),
                (i32,),
            > = Default::default();
            let mut path_indices_1_new: ascent::internal::RelIndexType1<
                (i32,),
                (i32,),
            > = Default::default();
    ...
    fn update_indices_priv(&mut self) {
        ...
        for (_i, tuple) in self.path.iter().enumerate() {
            ...
            let rel_ind = &mut self.path_indices_1;
            ascent::internal::RelIndexWrite::index_insert(
                rel_ind,
                selection_tuple,
                (tuple.0.clone(),),
