...
logical indices: odd_indices_0*/
    pub odd: ::std::vec::Vec<(i32,)>,
    pub __odd_ind_common: (),
    pub odd_indices_0: ascent::internal::RelFullIndexType<(i32,), ()>,
    ...
    pub fn run(&mut self) {
        ...
        ascent::internal::comment("scc 1");
        {
            ...
            let mut odd_indices_0_total: ascent::internal::RelFullIndexType<
                ...
                (),
            > = Default::default();
            let mut odd_indices_0_new: ascent::internal::RelFullIndexType<(i32,), ()> = Default::default();
            ::ascent::internal::RelIndexMerge::init(
            ...
            let even_indices_0_total: ascent::internal::RelFullIndexType<(i32,), ()> = std::mem::take(
                &mut _self.even_indices_0,
            );
            let __number_ind_common_total: () = std::mem::take(
                &mut _self.__number_ind_common,
            );
            ...
            #[allow(unused_assignments, unused_variables)]
            {
                ...
                ascent::internal::comment(
                    "odd <-- number_indices_none_total, agg even_indices_0",
                );
                {
                    if let Some(__matching) = number_indices_none_total
                        .to_rel_index(&__number_ind_common_total)
                        .index_get(&())
                    {
                        __matching
                            .for_each(|__val| {
                                let __val = __val.tuple_of_borrowed();
                                let x: &i32 = __val.0;
                                let __aggregated_rel = even_indices_0_total
                                    .to_rel_index(&__even_ind_common_total);
                                let __matching = __aggregated_rel.index_get(&(x.clone(),));
